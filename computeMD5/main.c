...
int main(int argc, char *argv[])
{
    ...
    // test file md5
    const char* fp = "/Users/mabingtao/work/gravs/graverobberclient/unity/Reso/uispines-module-shouchong_bf2cc6038d87cfff617b1079f1d61bd6";
    ret = Compute_file_md5(fp, md5_str);
    if (0 == ret)
    {
